...
class TestProcess:
    ...
    def test_reforecast_process(self, mocker, enxemble_raw, processed_data_forecast):
        """
        Test that the dataset generated by the process method of
        GlofasReforecast with default parameters is as expected
        """
    ...
    def test_forecast_process(self, mocker, enxemble_raw, processed_data_forecast):
        """
        Test that the dataset generated by the process method of
