...
class TestDownload:
    ...
    def test_reanalysis_download(self, fake_mkdir, fake_retrieve):
        ...
        """
        glofas_reanalysis = indicators.flooding.glofas.glofas_reanalysis.GlofasReanalysis(data_dir=TMP_PATH)
    ...
    def test_forecast_download(self, fake_mkdir, fake_retrieve):
        ...
        with default parameters is as expected
        """
        glofas_forecast = indicators.flooding.glofas.glofas_forecast.GlofasForecast(data_dir=TMP_PATH)
    ...
    def test_reforecast_download(self, fake_mkdir, fake_retrieve):
        ...
        """
        glofas_reforecast = indicators.flooding.glofas.glofas_forecast.GlofasReforecast(data_dir=TMP_PATH)
...
class TestProcess:
    ...
    def test_forecast_process(self, fake_open_mfdataset):
        ...
        cf_raw, pf_raw, expected_dis24 = self.get_enxemble_raw()
        fake_open_mfdataset.side_effect = [cf_raw, pf_raw]
        glofas_forecast = indicators.flooding.glofas.glofas_forecast.GlofasReforecast(data_dir=TMP_PATH)
