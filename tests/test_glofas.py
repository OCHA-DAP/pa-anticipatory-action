...
class TestProcess:
    ...
    @pytest.fixture()
    def open_mfdataset(self, mocker, enxemble_raw):
    ...
    @pytest.fixture()
    def processed_data_reanalysis(self):
        return self.get_processed_data()

    @pytest.fixture()
    def processed_data_forecast(self, enxemble_raw):
        return self.get_processed_data(
    ...
    def test_reanalysis_process(self, monkeypatch, processed_data_reanalysis):
        """
    ...
    def test_reforecast_process(self, open_mfdataset, processed_data_forecast):
        """
        Test that the dataset generated by the process method of
        GlofasReforecast with default parameters is as expected
        """
    ...
    def test_forecast_process(self, open_mfdataset, processed_data_forecast):
        """
        Test that the dataset generated by the process method of
