...
trigger_list <- c(name_a, name_b, name_c) # simplified for 2023 comparison
...
# paths
folder_2023 <- paste0(data_folder_path, "2023/")
...
# 2023 methodology performance check
perf_metrics_95_filename <- paste0(data_folder_path, country_pcode3, "_perf_metrics_table_ci_0.95_update.csv")
perf_metrics_68_filename <- paste0(data_folder_path, country_pcode3, "_perf_metrics_table_ci_0.68_update.csv")
```
...
hist_act <- read.csv(paste0(data_folder_path, "historical_activations_2023_methodology.csv"))
...
for(trigger in c(trigger_list, scenario_list)) {
  ...
  png(filename = paste0("plots/2023/", filename), width = 500, height = 400, units = "px")
  print(output$p)
  invisible(dev.off())
}
...
plots_to_trim <- grep(list.files(path = "./plots/2023/"), 
                      pattern = 'trimmed_', 
                      invert = TRUE, 
...
for (filename in plots_to_trim) {
  ...
  # read in the image
  original_plot <- magick::image_read(paste0("plots/2023/", filename))
  
  # trim the image
  trimmed_plot <- magick::image_trim(original_plot)
  
  # save trimmed plot
  magick::image_write(trimmed_plot, path = paste0("plots/2023/trimmed_", filename), format = "png")
...
snapshot_df <- data.frame(row_name = c('Type', 
                       ...
                       trigger_a = c(type_a, 
                                     ...
                                     monitored_by_a,
                                     package_a, 
                                     "<img src=plots/2023/trimmed_Trigger1_atv.png>",
                                     funding_a_formatted,
                                     expected_cost_a,
                                     "<img src=plots/2023/trimmed_Trigger1_var_tradeoff_bar.png>", 
                                     "<img src=plots/2023/trimmed_Trigger1_det_tradeoff_bar.png>"),
                       trigger_b = c(type_b,
                                     monitored_area_b,
                                     timepoints_b, 
                                     targeted_window_b, 
                                     ...
                                     monitored_by_b,
                                     package_b, 
                                     "<img src=plots/2023/trimmed_Trigger2_atv.png>", 
                                     funding_b_formatted,
                                     expected_cost_b,
                                     "<img src=plots/2023/trimmed_Trigger2_var_tradeoff_bar.png>",
                                     "<img src=plots/2023/trimmed_Trigger2_det_tradeoff_bar.png>"),
                       trigger_c = c(type_c, 
                                     monitored_area_c,
                                     timepoints_c, 
                                     targeted_window_c, 
                                     ...
                                     monitored_by_c,
                                     package_c, 
                                    "<img src=plots/2023/trimmed_Trigger3_atv.png>", 
                                     funding_c_formatted,
                                     expected_cost_c,
                                     "<img src=plots/2023/trimmed_Trigger3_var_tradeoff_bar.png>",
                                     "<img src=plots/2023/trimmed_Trigger3_det_tradeoff_bar.png>"))
...
activation_df <- data.frame(row_name = c(paste0('Yearly Disbursements', footnote_marker_number(1)), 
                           ...
                           atv_stats = c("<img src=plots/2023/trimmed_framework-min_atv_tradeoff_bar.png>",  
                                         "<img src=plots/2023/trimmed_framework-full_atv.png>",
                                         "<img src=plots/2023/trimmed_framework-p1_atv.png>", 
                                         "<img src=plots/2023/trimmed_framework-p2_atv.png>"))
...
```{r timepoint-tables, include = FALSE, eval = FALSE}
## Annex (lines 495-497)
...
```{r timpoint_table2, eval = F, include=FALSE}
kbl(timepoint_df2,
    format = 'html',
    escape = FALSE,
    row.names = FALSE, 
