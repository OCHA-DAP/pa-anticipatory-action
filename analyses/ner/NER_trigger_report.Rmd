...
trigger_list <- c(name_a, name_b, name_c, "Jan", "Feb", "Mar", "Apr", "May", "June")
...
output <- plotCI(trigger_id = "Trigger2", 
                 metric_name = metric)

# save plot as png
filename <- paste0('Trigger2', "_", metric, "_ci.png")
png(filename = paste0("plots/", filename), width = 815, height = 410, units = "px")
print(output$plot)
dev.off()
  
# save segment_dimensions in summary
segment_dim_temp <- data.frame(trigger_id = 'Trigger2', metric_name = metric, output$segment_dims)
