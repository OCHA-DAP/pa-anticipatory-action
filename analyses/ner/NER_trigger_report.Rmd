...
perf_metrics_filename <- paste0(data_folder_path, country_pcode3, "_perf_metrics_table_ci_", ci / 100, ".csv")
...
df_a_var <- computeCIwidths(perf_metrics_df = perf_metrics_data, metric_name = 'var', trigger_id = name_a) # valid activation rate 
