...
# Table footnotes
trigger_table_footnote <- "Triggers 1 and 2 can reach their threshold and activate independently from one another. Trigger 3 can only be met if Trigger 2 was not met. See Annex for performance metrics per timepoint. Trigger 3 performance assessed by comparing SPI-based activations with historical bad years."

full_atv_definition <- "A full activation is defined as Triggers 1 and 2 being met, or as Triggers 1 and 3 being met."
...
<br>
<p style="color:black;font-size:16px;text-align:left;"> Confidence intervals in <span style="color: blue;">blue</span> represent activation likelihood, those in <span style="color: green;">green</span> represent desired outcomes (valid non-activations/activations) and those in <span style="color: red;">red</span> represent undesired outcomes or errors.</p>
...
<p style="color:black;font-size:16px;text-align:left;"> This section examines the likelihood of activation in a given year under various scenarios. The estimates are presented as confidence intervals to illustrate their inherent uncertainty. The graphs show how likely it is that a scenario will occur (darker coloured band, 68% of years) as well as the highest and lowest probability that a scenario will occur (full coloured band, 95% of years).</p>

&nbsp;

```{r activation-table}
activation_df <- data.frame(row_name = c(paste0('Partial or full framework', footnote_marker_number(1)), 
                                        paste0('Full framework', footnote_marker_number(2)),
                           ...
                           atv_stats = c("<img src=plots/trimmed_framework-min_atv.png>",  
                                         ...
                                         "<img src=plots/trimmed_Trigger1_atv.png>", ##FIX ME
                                         "<img src=plots/trimmed_framework-min_atv.png>", ##FIX ME
                                         "<img src=plots/trimmed_framework-min_atv.png>"),##FIX ME
                           yearly_dist = c("",
...
kbl(activation_df,
  ...
  kableExtra::footnote(general_title = "Notes",
                       ...
                       number = c("Partial activation: At least one trigger being met",
                        paste0("Full activation: ", full_atv_definition), 
                        paste0("Package 1 activation: ", package1_atv_definition),
                        paste0("Package 2 activation: ", package2_atv_definition),
                        "No activation: None of the packages are activated."))
