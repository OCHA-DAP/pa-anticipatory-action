...
kbl(snapshot_df,
  ...
  row_spec(c(1:11), extra_css = "line-height: 30px;") %>%
  row_spec(c(12:13), extra_css = "line-height: 80px;") %>%
  ...
  pack_rows("Programming and Funding", start_row = 9, end_row = 11, color = '#1bb580') %>%
  pack_rows("Performance", start_row = 12, end_row = 13
            , color = '#1bb580') %>%
