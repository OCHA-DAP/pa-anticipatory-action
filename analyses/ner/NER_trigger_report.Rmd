...
kbl(snapshot_df,
  ...
  row_spec(c(11:13), extra_css = "line-height: 45px;") %>%
  ...
  pack_rows("Performance", start_row = 11, end_row = 13
            , color = '#1bb580') %>%
  kableExtra::footnote(general_title = "Notes",
                       general = trigger_table_footnote)
# (X% of all activations expected to be followed by a shock)
