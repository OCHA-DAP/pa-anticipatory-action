...
<p style="color:black;font-size:16px;text-align:left;"> This section examines the likelihood of activation in a given year under various scenarios. The estimates are presented as confidence intervals to illustrate their inherent uncertainty. The graphs show how likely it is that a scenario will occur most years (darker coloured band, 68% of the time) and the most or least likely that a scenario is to occur (full coloured band, 95% of the time).</p>
