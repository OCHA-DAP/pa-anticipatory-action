...
package2_atv_definition <- paste0(package2_atv_definition, " Historically P2 disbursement was triggered by the predictive trigger (Trigger 2) ", round(100*p2_pred/p2_tot, 0),"% of the time and by the observational trigger (Trigger 3) ", round(100*p2_obs/p2_tot, 0), "% of the time.")
```
