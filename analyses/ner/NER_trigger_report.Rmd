...
plots_to_trim <- grep(list.files(path="./plots"), pattern='trimmed_', invert=TRUE, value=TRUE) # excludes 'trimmed_' graphs, which will be overwritten
...
timepoint_df <- data.frame(row_name = c('Triggering Prob.',
                                       ...
                                       'False Alarms', 
                                       'Misses'),
                       trigger_jan = c(paste0("<img src=plots/trimmed_Jan_atv.png>"),
                                     paste0("<img src=plots/trimmed_Jan_var.png"), 
                       ...
                       trigger_feb = c("<img src=plots/trimmed_Feb_atv.png>",
                                     paste0("<img src=plots/trimmed_Feb_var.png"),
                       ...
                       trigger_mar = c("<img src=plots/trimmed_Mar_atv.png>", 
                                     paste0("<img src=plots/trimmed_Mar_var.png"),
                       ...
                       trigger_apr = c("<img src=plots/trimmed_Apr_atv.png>",
                                     paste0("<img src=plots/trimmed_Apr_var.png"),
                       ...
                       trigger_may = c("<img src=plots/trimmed_May_atv.png>",
                                    paste0("<img src=plots/trimmed_May_var.png"),
                       ...
                       trigger_jun = c("<img src=plots/trimmed_June_atv.png>",
                                     paste0("<img src=plots/trimmed_June_var.png"),
