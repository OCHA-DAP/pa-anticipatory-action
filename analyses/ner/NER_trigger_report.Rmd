...
# Create a CI visual for atv for each trigger + activation timepoint
...
for(trigger in c(name_a, name_b, name_c)) {
...
# Plot top/bottom CIs for individual triggers (var, det, far, mis)
for(trigger in trigger_list) {
  for (metric in c('var', 'det')) {
  ...
  # save plots as png's
  top_p_filename <- paste0(trigger, "_", metric, "_top_p.png")
  png(filename = paste0("plots/", top_p_filename), width = 500, height = 400, units = "px")
  print(output$top_p)
  
  bottom_p_filename <- paste0(trigger, "_", metric, "_bottom_p.png")
  png(filename = paste0("plots/", bottom_p_filename), width = 500, height = 400, units = "px")
  print(output$bottom_p)
  dev.off()
  }
}

# Plot top/bottom CIs for activation scenarios
output <- plotCI(trigger_id = "framework-min", "atv")

 top_p_filename <- paste0("framework-min_atv_top_p.png")
  png(filename = paste0("plots/", top_p_filename), width = 683, height = 318, units = "px")
  print(output$top_p)
  dev.off()
  
  bottom_p_filename <- paste0("framework-min_atv_bottom_p.png")
  png(filename = paste0("plots/", bottom_p_filename), width = 683, height = 318, units = "px")
  print(output$bottom_p)
  dev.off()
```
