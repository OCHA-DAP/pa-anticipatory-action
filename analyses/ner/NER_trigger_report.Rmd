...
<br>
<p style="color:black;font-size:16px;text-align:left;"> Confidence intervals in <span style="color: blue;font-weight: bold;">blue</span> represent activation likelihood, those in <span style="color: green;font-weight: bold;">green</span> represent desired outcomes (valid non-activations/activations) and those in <span style="color: red;font-weight: bold;">red</span> represent undesired outcomes or errors.</p>
