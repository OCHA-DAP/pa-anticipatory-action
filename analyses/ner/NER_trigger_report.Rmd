...
framework_df <- data.frame(row_name = c('At least one trigger being met (probability in %)', 
                           ...
                           frmwk_stats = c("<img src=plots/trimmed_framework-min_atv.png>",  
...
```{r move-plots-out-of-repo}

# list all plots in code repo
plots_to_move <- list.files(path = "./plots", full.names = TRUE)

# copy to Data folder repo
file.copy(from = plots_to_move, to = paste0(data_folder_path, "plots/"))

# delete plots in repo folder
file.remove(plots_to_move)
