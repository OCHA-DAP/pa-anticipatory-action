...
```{r functions}
source("../country_template/docs/plotATV.R")
source("../country_template/docs/plotTradeoffs.R")
...
metrics_list <- c('det', 'far', 'mis', 'var') # trigger activation prob, detection rate, false alarm rate, miss rate, valid activation rate 
