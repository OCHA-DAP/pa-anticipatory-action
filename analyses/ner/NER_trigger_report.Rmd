...
This table summarises the definition of the triggers and their performance in signaling the target severe shocks. The performance metrics are presented as `r ci`% confidence intervals to illustrate the inherent uncertainty of these measurements. The coloured graphs represent the ranges within which the trigger will perform `r ci`% of the time.
...
This table reports the performance metrics for the predictive triggers per timepoint.
