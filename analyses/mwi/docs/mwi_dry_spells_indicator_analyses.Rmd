...
plot_seasonal_dir <- paste0(plot_dir, '/seasonal/unrounded-coords')
...
![](`r paste0(plot_seasonal_dir,'/seasonal_below_average_confusionmatrix.png')`)
...
![](`r paste0(plot_seasonal_dir,'/mwi_plot_monthly_precipitation_boxplot_decjanfeb_southern_ds73_adm1.png')`)
...
![](`r paste0(plot_seasonal_dir,glue('/mwi_plot_monthly_precipitation_threshold_missfalse_ds{min_days_ds}{min_adm_ds}_adm1_permonth.png'))`)

We combined months to determine what (single) threshold could be applied to both months in a trigger.

![](`r paste0(plot_seasonal_dir,'/mwi_plot_monthly_precipitation_threshold_missfalse_janfeb_southern_ds73.png')`)
...
![](`r paste0(plot_seasonal_dir,glue('/mwi_plot_monthly_precipitation_confusionmatrix_janfeb_southern_ds73_th{thresh_mon_prec}.png'))`)
...
![](`r paste0(plot_seasonal_dir,glue('/mwi_boxplot_formonth_dsobs_perlt_perc_50_{adm_str}_{month_str}.png'))`){width=70%}
...
![](`r paste0(plot_seasonal_dir,glue('/mwi_plot_formonth_dsobs_missfalse_perc_50_{adm_str}_{month_str}.png'))`)

With the threshold at `r {thresh_month_for}`, we computed the confusion matrix per leadtime:

![](`r paste0(plot_seasonal_dir,glue('/mwi_plot_formonth_dsobs_cm_lt123456_th{thresh_month_for}_perc_50_{adm_str}_{month_str}.png'))`)
...
![](`r paste0(plot_seasonal_dir,glue('/mwi_plot_formonth_dsobs_cm_lt24_th{thresh_month_for}_perc_50_{adm_str}_jan.png'))`){width=100%}
![](`r paste0(plot_seasonal_dir,glue('/mwi_plot_formonth_dsobs_cm_lt24_th{thresh_month_for}_perc_50_{adm_str}_feb.png'))`){width=100%}
