...
df_dryspells <- read.csv(paste0(processed_country_dir, 'dry_spells/v1/dry_spells_during_rainy_season_list_2000_2021_mean_back.csv'))
df_dryspells_px <- read.csv(paste0(processed_country_dir, 'dry_spells/v1/ds_counts_per_pixel_adm1.csv'))
...
temp_dir = paste0(processed_country_dir, 'dry_spells/v1/gee_output/')
