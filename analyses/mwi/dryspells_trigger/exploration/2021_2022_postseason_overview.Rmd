...
par(mfrow = c(1,1),
    mar = c(0, 0, 0, 0))
plot(NULL,xaxt='n',yaxt='n',bty='n',ylab='',xlab='', xlim=0:1, ylim=0:1, mar = NA, ) 
legend("top",
       inset = c(0.5, 0.2), # Distance from the margin as a fraction of the plot region,
       legend = seq(lg_min, lg_max - 1), 
       fill = RColorBrewer::brewer.pal(name = "Oranges", n = lg_max - 1), 
       horiz = T, 
       cex = 0.8)
```
