...
## Report Structure
The analysis provides an exploration of the data and an answer to the following questions, which were open and can speak to the adeqaucy of the trigger mechanism:
...
## On the Rainy Season
We look at when the rainy season began and ended, and therefore how long it lasted, throughout the Southern Region.
