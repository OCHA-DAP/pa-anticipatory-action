...
```python
ds = arc2_centr.load_raw_data(convert_date=False)
...
We can look at the differences between these in more detail in the `mwi_agg_exploration.Rmd` and explore the various raster data provided here.
