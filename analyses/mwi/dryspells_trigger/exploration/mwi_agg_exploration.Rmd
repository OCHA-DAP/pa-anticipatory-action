...
df_list <- map(methods, ~read_csv(
  file.path(arc2_dir, glue("arc2_{.x}_mwi_dry_spells_14_days_32E_36E_20S_5S_master.csv"))
...
df_prec_list <- map(methods, ~read_csv(
  file.path(arc2_dir, glue("arc2_{.x}_long_mwi_rolling_sum_14_days_32E_36E_20S_5S_master.csv"))
...
- Centroid method, original 0.1º
- Touching method, original 0.1º
- Centroid method, upsampled 0.025º (approximate mask)
