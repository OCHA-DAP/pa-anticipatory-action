...
## Background
This document summaries all the data work that has been done to inform the trigger mechanism for OCHA Anticipatory Action pilot in Malawi related to prolonged dry spells. It explores the historical dry spells, relations with seasonal observed indicators, and the skill of short-term forecast to predict these dry spells. All work presented here has been done by the Centre for Humanitarian Data, but with indispensable help from technical partners. All the code is openly available [here](https://github.com/OCHA-DAP/pa-anticipatory-action), and will regularly be referred to in this document. 

### Previous work
[Assuming now that we will have a separate document for defining historically observed dry spells and add literature on that there]
To build our analyses, we reviewed previous literature on forecasting dry spells. Generally the body of work on forecasting dry spells is rather limited, and we are not aware of any work attempting to forecast prolonged dry spells in Malawi. However, @streefkerk2020linking researched the ability to forecast 5-day long dry spells. She looked at the correlation between these dry spells and the meteorological indicators of temperature, wind speed, wind direction and ENSO strength. These indicators were chosen, as she showed these are commonly used by local farmers. She showed that these indicators do have predictive value for the occurence of the 5-day dry spells, while these correlations heavily depend on the location. Moreover, the analysis suggests that the while the ENSO phenomenon has predictive value for overall drought, it is less decisive for the occurence of dry spells, as these are more local events. 
While not focusing on forecasting, @mittal2021co investigated the correlation with total precipitation in a 3-month period and the occurence of a prolonged dry spell in Malawi. This work defines a dry spell as 14 consecutive dry days, where a dry day is a day with <=2mm of precipitation. They found that there was only a weak correlation between the occurence of a dry spell and the total 3-monthly precipitation, where again the strength of the correlation heavily depended on the location. 

Moving away from Malawi, @gbangou2020rainfall researched the predictability of dry spells in Ghana. They analyze how well the forecasts can predict the number of dry spells within a season, where a dry spell is defined as at least 5 consecutive days with less than 1mm of rainfall per day. Moreover, they try to forecast the length of the longest dry spell. For the forecasting, ECMWF's seasonal forecast as well as a statistical model based on Sea Surface Temperatures (SST) is used. They show that skill of these two forecasts, depend on the lead time and location. However, they show the correlations are generally weak. Interestingly, the forecasts do show to be better at predicting the extreme years, though the correlations are still not strong. Nevertheless, they argues that the forecasts have better skill than guessing based on climatologies and thus can be used to inform actions.
