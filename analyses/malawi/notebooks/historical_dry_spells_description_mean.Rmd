...
Over the 20-year span, `r nbr_ds` dry spells were observed. `r perc_distr_ds`% of districts experienced a dry spell (`r nbr_distr_ds`/`r nbr_distr`). Most dry spells (`r max_ds`) were observed in `r knitr::combine_words(max_ds_dist)`.
