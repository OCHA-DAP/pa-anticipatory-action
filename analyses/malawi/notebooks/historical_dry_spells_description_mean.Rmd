...
**Rainy season cessation:** First day of a 15-day period after 15 March with 25mm or less of rain (DCCMS 2008). The cessation date is the first day of this 15 day period. 
...
#### Duration
```{r ds-duration-stats}
max_dur <- max(rainy_season_dry_spells_summary_per_region$max_ds_duration)
mean_dur <-mean(rainy_season_dry_spells_summary_per_region$mean_ds_duration)
min_mean_dur <-min(rainy_season_dry_spells_summary_per_region$mean_ds_duration)
max_mean_dur <-max(rainy_season_dry_spells_summary_per_region$mean_ds_duration)
