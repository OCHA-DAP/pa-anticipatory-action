...
A dry spell was included if at least 1 day on which the criterion was met fell during the rainy season. In other words, a dry spell was included when it overlapped with the rainy season, even if it started before or ended after it. A summary per district is presented below.
...
We next looked at when dry spells were more likely to occur, as the timing affects the shock's impact on crops. The  majority started in April (73.1%) and March (20.7%). We note that no or few dry spells were observed in Dec and Jan, respectively. This may partly be due to our definition of rainy season onset, which requires that a rainy streak not be followed by a 10-day period with less than 2mm rainfall in the next 30 days for the streak to be considered the onset of the rainy season. Therefore by definition the first month of the rainy season cannot have dry spells.
