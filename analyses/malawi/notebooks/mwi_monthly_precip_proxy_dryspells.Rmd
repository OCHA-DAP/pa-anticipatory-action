...
- I am currently aggregating dry spells from admin2 to admin1, by saying if any of the admin2's experienced a dry spell, so did the admin1. Do you think this is a good methodology or should we take severity into account? 
  - we could do pixel-based as well, but then we need to set a pixel threshold (would suggest 30%), and we need to recompute them outside the rainy season.
...
- Defines a dry spell as less than 2mm cumulative precipitation during 14 consecutive days. The second part of the analysis compares this with a definition of 14 consecutive dry days, where a dry day is defined as receiving less than 4mm on one day. 
...
- Aggregates historical dry spells and monthly precipitation to admin1 (Southern region), since forecasts have too much spatial uncertainty to forecast ad the admin2 level
