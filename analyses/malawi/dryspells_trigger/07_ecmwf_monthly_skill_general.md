...
da_lt_interp=da_lt.interp(latitude=da_obs["latitude"],longitude=da_obs["longitude"],method="nearest")
```
...
forecast_ensmean=forecast.mean(dim="number")
```
