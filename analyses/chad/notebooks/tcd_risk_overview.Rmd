...
Les facteurs varient par région comme on peut le voir ci-bas. 

## Survol géographique de facteurs clé
...
```{r sector, dpi=300, include=T, message= FALSE, warning=FALSE, fig.height=3, fig.align="center", eval=F}
...
```{r img1, echo = FALSE, include=T, fig.align='center', out.width='75%', eval=F}
