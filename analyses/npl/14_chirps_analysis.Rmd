...
print(paste0("The proportion of false negative events to number of actual flood events is: ", round(FNRate*100, 2), "%."))
...
print(paste0("The proportion of false negative events to number of actual events is: ", round(FNRate2*100, 2), "%."))
...
print(paste0("The proportion of false positive CHIRPS events to number of CHIRPS events is: ", round(FPRate2*100, 2), "%."))
...
print(paste0("The proportion of false positive events to number of CHIRPS events is: ", round(FNRate2*100, 2), "%."))

```

# Comparing Water Levels and GLOFAS Event
