...
There are 2 districts in the Historical Floods file not found in the shapefile. On further inspection, there seems to be very slight differences in the name that can be explained by data entry. Changing Makwanpur to Makawanpur and Dhanusa to Dhanusha:
...
There is data for 2 districts for the Karnali River Basin and data for 3 districts for the Saptakoshi watershed.
