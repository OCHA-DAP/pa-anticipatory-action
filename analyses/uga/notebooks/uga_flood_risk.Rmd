...
For each adm2 we list below its population density. Each column can be searched and sorted. Upon requested age groups can be modified and/or further broken down by gender.
...
#  rename(Sex_M = M_TOTAL,
#          Sex_F = F_TOTAL) %>%
#  knitr::kable(caption = "Population Summary by Sex and Age",
#                align = c('l'),
#               format.args = list(big.mark = ",")) %>%
#         #collapse_rows(columns = 1, valign = "top") %>%
#         add_header_above(c("Area" = 2, "Total Pop" = 1,"Sex" = 2, "Age" = 5)) %>% 
...
DT::datatable(pop_summary, 
              ...
              filter = 'top', 
              options = list(pageLength = 40, fillContainer = T)) %>%
