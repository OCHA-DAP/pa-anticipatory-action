...
raster::plot(data_masked, xlim = c(29.57501, 35.00001), ylim = c(-1.483236, 4.233431), axes = FALSE, box = FALSE, legend = TRUE)
raster::plot(adm3_shp$geometry, xlim = c(29.57501, 35.00001), ylim = c(-1.483236, 4.233431), border = "grey", add = TRUE)
dev.off()
