---
title: "Estimating flooding dynamics in Bangladesh"
...
choro_map(df_summ, shp_mauz, 'PEAK_G_DAYS', 'PuBuGn', TRUE, 'plot')
...
choro_map(df_summ, shp_mauz, 'FWHM', 'YlGnBu', TRUE, 'plot')
