...
# plot
ci_color <- ifelse(metric %in% c('var', 'det', 'acc'), "#1bb580", ifelse(metric %in% c('min', 'ful', 'atv'), "#007ce1" ,"#FF3333")) # select green for detection and valid activation rates, blue for framework probabilities, red for the others
