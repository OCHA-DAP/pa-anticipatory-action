...
# plot
ci_color <- ifelse(metric %in% c('var_ci', 'det_ci', 'acc_ci'), "#1bb580", ifelse(metric %in% c('min_ci', 'ful_ci'), "007ce1" ,"#FF3333")) # select green for detection and valid activation rates, blue for framework probabilities, red for the others
