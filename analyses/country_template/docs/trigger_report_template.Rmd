...
trigger_a_perf_metrics_filename <- "dummy_table_for_template.csv" # include path
...
trigger_b_perf_metrics_filename <- "dummy_table_for_template.csv" # include path
...
trigger_c_perf_metrics_filename <- "dummy_table_for_template.csv" # include path
...
df <- read.csv(trigger_a_perf_metrics_filename)
