...
# TO CHECK df_trigger_a etc still used? format probabilities section? if not remove
```
...
snapshot_df <- data.frame(row_name = c('Type', 
                       ...
                       trigger_b = c(type_b, 
                                     ...
                                     package_b, 
                                     funding_b, 
                                     paste0("<img src=trimmed_trigger_b_var_ci.png"), # TO CHANGE to prob of trigger activation CI plot 
