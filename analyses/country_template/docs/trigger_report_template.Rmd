...
threshold_a <- "" # eg: "35% of driest years"
...
```{r hard-coded-values-ner, echo = FALSE, message = FALSE, warning = FALSE}
country_name <- "Niger"
country_pcode3 <- "ner"
shock <- "Drought"
...
threshold_a <- "35% of driest years"
threshold_b <- "35% of driest years"
threshold_c <- "35% of driest years"
...
for (filename in plots_to_trim) {
  ...
  # save trimmed plot
  magick::image_write(trimmed_plot, path = paste0(plots_folder_path, "trimmed_", filename), format = "png")
}
```
...
```{r image-links}
# atv plots
trigger1_atv_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger1_atv.png")
trigger2_atv_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger2_atv.png")
trigger3_atv_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger3_atv.png")

# var tradeoff plots
trigger1_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger1_var_tradeoff_bar.png")
trigger2_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger2_var_tradeoff_bar.png")
trigger3_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger3_var_tradeoff_bar.png")

# det tradeoff plots
trigger1_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger1_det_tradeoff_bar.png")
trigger2_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger2_det_tradeoff_bar.png")
trigger3_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Trigger3_det_tradeoff_bar.png")

# framework activation plots
fmwk_min_png_link <- paste0(data_folder_path, "plots/trimmed_framework-min_atv_tradeoff_bar.png")
fmwk_full_png_link <- paste0(data_folder_path, "plots/trimmed_framework-full_atv.png")
fmwk_p1_png_link <- paste0(data_folder_path, "plots/trimmed_framework-p1_atv.png")
fmwk_p2_png_link <- paste0(data_folder_path, "plots/trimmed_framework-p2_atv.png")

# Timepoint activation plots
jan_atv_png_link <- paste0(data_folder_path, "plots/trimmed_Jan_atv.png")
jan_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Jan_var_tradeoff_bar.png")
jan_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_Jan_det_tradeoff_bar.png")

feb_atv_png_link <- paste0(data_folder_path, "plots/trimmed_feb_atv.png")
feb_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_feb_var_tradeoff_bar.png")
feb_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_feb_det_tradeoff_bar.png")

mar_atv_png_link <- paste0(data_folder_path, "plots/trimmed_mar_atv.png")
mar_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_mar_var_tradeoff_bar.png")
mar_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_mar_det_tradeoff_bar.png")

apr_atv_png_link <- paste0(data_folder_path, "plots/trimmed_apr_atv.png")
apr_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_apr_var_tradeoff_bar.png")
apr_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_apr_det_tradeoff_bar.png")

may_atv_png_link <- paste0(data_folder_path, "plots/trimmed_may_atv.png")
may_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_may_var_tradeoff_bar.png")
may_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_may_det_tradeoff_bar.png")

jun_atv_png_link <- paste0(data_folder_path, "plots/trimmed_jun_atv.png")
jun_var_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_jun_var_tradeoff_bar.png")
jun_det_tradeoff_png_link <- paste0(data_folder_path, "plots/trimmed_jun_det_tradeoff_bar.png")
...
snapshot_df <- data.frame(row_name = c('Type', 
                       ...
                       trigger_a = c(type_a, 
                                     ...
                                     monitored_by_a,
                                     package_a, 
                                     pandoc.image.return(trigger1_atv_png_link),
                                     funding_a_formatted,
                                     expected_cost_a,
                                     pandoc.image.return(trigger1_var_tradeoff_png_link),
                                     pandoc.image.return(trigger1_det_tradeoff_png_link)),
                       trigger_b = c(type_b,
                                     monitored_area_b,
                                     timepoints_b, 
                                     targeted_window_b, 
                                     ...
                                     monitored_by_b,
                                     package_b, 
                                     pandoc.image.return(trigger2_atv_png_link),
                                     funding_b_formatted,
                                     expected_cost_b,
                                     pandoc.image.return(trigger2_var_tradeoff_png_link),
                                     pandoc.image.return(trigger2_det_tradeoff_png_link)),
                       trigger_c = c(type_c, 
                                     monitored_area_c,
                                     timepoints_c, 
                                     targeted_window_c, 
                                     ...
                                     monitored_by_c,
                                     package_c, 
                                     pandoc.image.return(trigger3_atv_png_link),
                                     funding_c_formatted,
                                     expected_cost_c,
                                     pandoc.image.return(trigger3_var_tradeoff_png_link),
                                     pandoc.image.return(trigger3_det_tradeoff_png_link)))
...
activation_df <- data.frame(row_name = c(paste0('Yearly Disbursements', footnote_marker_number(1)), 
                           ...
                           atv_stats = c(pandoc.image.return(fmwk_min_png_link),
                                         pandoc.image.return(fmwk_full_png_link),
                                         pandoc.image.return(fmwk_p1_png_link),
                                         pandoc.image.return(fmwk_p2_png_link)))
...
jun_atv_png_link <- 
jun_var_tradeoff_png_link 
jun_det_tradeoff_png_link <- 
  
timepoint_df1 <- data.frame(row_name = c('Prob. being met (%)',
                                        'All Activations (%)', 
                                       'All Shocks (%)'),
                       trigger_jan = c(pandoc.image.return(jan_atv_png_link),
                                       pandoc.image.return(jan_var_tradeoff_png_link),
                                       pandoc.image.return(jan_det_tradeoff_png_link)),
                       trigger_feb = c(pandoc.image.return(feb_atv_png_link),
                                       pandoc.image.return(feb_var_tradeoff_png_link),
                                       pandoc.image.return(feb_det_tradeoff_png_link)),
                       trigger_mar = c(pandoc.image.return(mar_atv_png_link),
                                       pandoc.image.return(mar_var_tradeoff_png_link),
                                       pandoc.image.return(mar_det_tradeoff_png_link)))

timepoint_df2 <- data.frame(row_name = c('Prob. being met (%)',
                                        'All Activations (%)', 
                                       'All Shocks (%)'),
                       trigger_apr = c(pandoc.image.return(apr_atv_png_link),
                                       pandoc.image.return(apr_var_tradeoff_png_link),
                                       pandoc.image.return(apr_det_tradeoff_png_link)),
                       trigger_may = c(pandoc.image.return(may_atv_png_link),
                                       pandoc.image.return(may_var_tradeoff_png_link),
                                       pandoc.image.return(may_det_tradeoff_png_link)),
                       trigger_jun = c(pandoc.image.return(jun_atv_png_link),
                                       pandoc.image.return(jun_var_tradeoff_png_link),
                                       pandoc.image.return(jun_det_tradeoff_png_link)))
kbl(timepoint_df1,
    format = 'html',
    escape = FALSE,
    row.names = FALSE, 
