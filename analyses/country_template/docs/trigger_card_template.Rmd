...
snapshot_df <- data.frame(row_name = c('Type', 
                                       ...
                                       'Prob. Min. Framework Activation', 
                                       'Prob. Full Framework Activation'),
                       trigger_a = c(type_a, 
                                     timepoints_a, 
                                     predicted_window_a, 
                                     lead_time_a, 
...
kbl(snapshot_df,
  ...
  pack_rows("Framework Activation", 15, 16, color = "black", label_row_css = "font-size: 12; font-style: italic; text-align: center; background-color: #E5E5E5;") %>%
  kableExtra::footnote(general = "", symbol = c("Each trigger can meet its threshold and activate independently from the others. Only 1 activation can occur per trigger in a given year."))
