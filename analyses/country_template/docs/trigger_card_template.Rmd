...
# Anticipatory Action Trigger Report
<br>
...
kbl(snapshot_df,
  ...
  kableExtra::footnote(general = "", general_title = "___", symbol = c("Each trigger can reach its threshold and activate independently from the others. Only 1 activation can occur per trigger in a given year."))
