...
date: "Analysis last updated: `r Sys.Date()`"
output:
  html_document:
    df_print: paged
    toc: yes
...
<img src="centre_logo.png" style="position:absolute;top:20px;right:0px;height:50px" />
<img src="ocha_logo.png" style="position:absolute;top:90px;right:0px;height:40px" />
